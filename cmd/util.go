...
import (
	...
	"github.com/mudler/netron/internal"
	"github.com/mudler/netron/pkg/config"
...
var CommonFlags []cli.Flag = []cli.Flag{
	...
	&cli.IntFlag{
		...
		EnvVars: []string{"NETRONPEERGATEINTERVAL"},
		Value:   120,
	},
}
...
func displayStart(ll *logger.Logger) {
	...
	ll.Infof("Version: %s", internal.Version)
}
