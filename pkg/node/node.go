...
import (
	...
	protocol "github.com/mudler/netron/pkg/protocol"

	"github.com/mudler/netron/pkg/blockchain"
	hub "github.com/mudler/netron/pkg/hub"
...
func New(p ...Option) (*Node, error) {
	c := &Config{
		...
		Store:                    blockchain.NewMemoryStore(consts.MAX_BLOCKS),
	}
...
func (e *Node) Start(ctx context.Context) error {
	...
	e.config.Logger.Info("Starting Netron network")
...
// messageWriter returns a new MessageWriter bound to the netron instance
